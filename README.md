...
- **Header**: 스크롤 시 상단에 고정되는 Sticky Header 구현 및 네비게이션 고정
...
### 4.1 SEO 기본원칙 적용
- header, main, footer, nav, ul, li, a 등의 시멘틱 태그를 활용하였습니다.
...
## 6. 성능 및 웹 표준 검증
- W3C HTML Validator,  W3C CSS Validator 통과 및 edge, chrome 등 브라우저 호환성 체크 완료
